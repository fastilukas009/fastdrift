...
import { Track, TRACK_BY_ID } from './tracks.js';
...
window.addEventListener('DOMContentLoaded', () => {
  try {
    ...
    l.innerHTML = '<span style="max-width:34ch;text-align:center;line-height:1.7">Peli ei käynnistynyt. '
      + 'Tarkista että selaimessa on WebGL käytössä.</span>';
    console.error(err);
  }
});
